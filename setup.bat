...
TITLE Clawey v12.9 - Setup Wizard

echo.
echo   ========================================================
echo        Clawey v12.9 - Setup Wizard
echo   ========================================================
echo.
...
if /i "%SETUP_ANDROID%"=="y" (
    ...
    if exist ClaweyApp (
        ...
        if %errorlevel% neq 0 (
            ...
            echo   2. Run: cd ClaweyApp ^&^& npx expo run:android
        ...
        echo [WARNING] ClaweyApp directory not found! Skipping.
    )
) else (
...
echo   ========================================================
echo.
echo   To start Clawey:    start.bat
echo   Dashboard:                http://localhost:5173
echo.
echo   Optional:
echo     Chrome Extension:       Load extension/ folder in chrome://extensions
echo     Android App:            cd ClaweyApp ^&^& npx expo run:android
