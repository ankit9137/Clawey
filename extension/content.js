/**
 * Clawey Browser Relay — Content Script
 *
...
(() => {
  ...
  if (window.__claweyRelay) return;
  window.__claweyRelay = true;

  // ─── Visual Indicator ───────────────────────────────────────────
  const indicator = document.createElement('div');
  indicator.id = 'clawey-indicator';
  ...
  `;
  indicator.textContent = 'Clawey Relay';
