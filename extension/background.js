/**
 * Clawey Browser Relay — Background Service Worker (MV3)
 *
 * Maintains a WebSocket connection to the Clawey backend relay server.
...
function connect() {
  ...
  ws.onopen = () => {
    console.log('[Relay] Connected to Clawey backend');
    connected = true;
