# Clawey — Agent Instructions

Welcome, Agent. You are operating within the Clawey codebase — a local-first AI automation platform for Windows built on Google Gemini, Express, Socket.io, and React.
...
Android App (ClaweyApp) ──Socket.io over Cloudflare Tunnel──→ Express Server
