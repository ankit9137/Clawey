...
const App: React.FC = () => {
  const [messages, setMessages] = useState<Message[]>([
    { id: '1', text: 'Welcome back. Clawey v12.6 is online and ready.', sender: 'bot', timestamp: new Date() }
  ]);
  ...
  useEffect(() => {
    ...
    newSocket.on('connect', () => {
      setConnected(true);
      addToast('Connected to Clawey', 'success');
    });
            ...
            {activeTab === 'activity' && (
              ...
              >
                ...
                <p style={{ color: 'var(--text-dim)', fontSize: '0.85rem', marginTop: '8px' }}>
                  Real-time events from all Clawey subsystems
                </p>
