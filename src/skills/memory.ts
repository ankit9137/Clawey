...
export const memorySkill: Skill = {
  ...
  description: 'Learns and persists important information about the user, their preferences, their specific terminology (like MSP jargon), and patterns from conversations. Use this to ensure Clawey evolves with the user.',
  parameters: {
    type: 'object',
    properties: {
      action: {
