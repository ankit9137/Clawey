# Clawey v12.6: End-User Guide 🛸
**Developed by Ankit Sharma**

![Clawey Logo](assets/logo.png)

Welcome to **Clawey v12.6**, your next-generation AI agent for Windows. This version features **Twitter/X Automation**, **Relay-Based Vision**, and the refined **v12 Org Orchestration** system.

---

## ⚡ How to Start

The fastest way to launch Clawey is using the included batch files:
...
Clawey supports creating autonomous AI companies that work on your projects without constant human intervention.
...
- **📸 Dashboard Screenshot**: Click the **Camera icon** next to the chat box (available in both the main chat and direct agent chat) to capture any window or your entire screen. A preview appears above the input — type an optional message and hit send. Clawey will process it immediately!
...
- **Extension Relay Mode (v10.3)**: Install the **Clawey Relay** Chrome extension to bridge the agent to your **real Chrome tabs**. No flags, no remote debugging — just install and go.
...
Clawey can now perform tasks on a schedule.
...
Clawey evolves by learning from your conversations.
...
*“Clawey: Your machine, your command, anywhere.”*
