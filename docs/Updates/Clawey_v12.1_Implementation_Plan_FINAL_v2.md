# Clawey v12.1 — Final Implementation Plan v2
...
111. **Live tool feed** — enable superuser mode → chat with Clawey → tool calls render inline as they execute, with pulsing animation
