# Clawey — LinkedIn Automation Plan (Local Machine)
...
Clawey and LinkedIn are both on the same local Windows machine.
...
written by Clawey instead of the hardcoded string:
...
def play_recording(steps_file, content_file):
    # Read content written by Clawey
...
if __name__ == "__main__":
    ...
    # Accept --content-file override from Clawey
...
Create this agent in your Clawey Enterprise org.
...
- Tuesday: Clawey feature spotlight with concrete use case
- Wednesday: MSP pain point + how Clawey solves it
...
8. Add `LINKEDIN_SCRIPT_DIR=C:\LinkedInBot` to Clawey `.env`
...
12. In Clawey chat: `use linkedin_post skill with dry_run: true, content: "test"`
...
15. In Clawey chat: `use linkedin_post to post: "Testing my new AI automation setup. More updates soon. #AI #Automation"`
...
18. Add Jordan to Clawey Enterprise org with above settings
