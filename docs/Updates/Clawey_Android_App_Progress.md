# Clawey Android App — Build Progress

**Last updated:** 2026-03-23 (session 2)
**App package:** `com.clawey.app`
...
**Error:** `Default FirebaseApp is not initialized in this process com.clawey.app`
**Cause:** Expo push notifications on Android require Firebase Cloud Messaging (FCM). Need `google-services.json`.
**Fix:**
1. Go to [Firebase Console](https://console.firebase.google.com) → Create project
2. Add Android app with package `com.clawey.app`
...
- Steps remaining:
  ...
  4. `cloudflared tunnel create clawey`
  5. `cloudflared tunnel route dns clawey api.utilization-tracker.online`
  6. `cloudflared tunnel run --url http://localhost:3000 clawey`
...
2. Add Android app → package name: `com.clawey.app`
3. Download `google-services.json` → place in `ClaweyApp/android/app/`
4. Rebuild: `npx expo run:android`
