# Clawey — Todos Feature Implementation Plan
...
If Clawey was offline when a recurring todo should have fired (e.g. reboot at 9am, daily todo fires at midnight):
...
*Clawey v13.0.0 — Todos Feature Implementation Plan*
*Built for: Ankit9137 | Author: Scout Kalra*
