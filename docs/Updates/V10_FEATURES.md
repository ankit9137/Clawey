# Clawey v10.0: Feature Guide (Legacy Reference) 🚀
...
**What it does:** Connects Clawey to the user's already-running Chrome browser — real logins, real tabs, no re-authentication.
...
**Automatic Alerts:**
- Connection: "Connected to Clawey" (success)
...
**Clawey v10.0: From assistant to autonomous agent.** 🛸
